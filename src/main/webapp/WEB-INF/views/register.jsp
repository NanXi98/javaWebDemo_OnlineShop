...
<div class="container-fluid"style="color:white">
    ...
    <div class="col-sm-offset-2 col-md-offest-2">
        ...
        <div  class="form-horizontal">
            ...
            <div class="form-group">
                <label for="inputEmail" class="col-sm-2 col-md-2 control-label">电子邮箱：</label>
                <div class="col-sm-6 col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6">
                    <input type="text" class="form-control" id="birthday" placeholder="xxxx年xx月xx日" />
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    function startRegister() {
        ...
        if(user.nickName === ''){
            ...
            layer.msg('密码长度不能少于5个字符',{icon:2});
            return;
        }
        if(checkPhone(user.phoneNumber)=== false){
            layer.msg('请输入有效手机号',{icon:2});
            return;
        }
        ...
        else if(user.postNumber==='')
        {
            layer.msg('请输入邮编',{icon:2});
            return;
        }
       else if(user.address==='')
       {
        ...
        else if(user.address.length>60)
        {
            layer.msg('地址过长',{icon:2});
            return;
        }
